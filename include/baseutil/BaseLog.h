...
extern CBaseLog* g_pLog;

#define    LOG_INIT					g_pLog->LogInit
#if defined(WIN32) || defined(WIN64)	
#define    LOG_INFO(...) 			g_pLog->LogInfo(__FILE__,__FUNCTION__,__LINE__,##__VA_ARGS__) 	
#define    LOG_WARN(...) 			g_pLog->LogWarn(__FILE__,__FUNCTION__,__LINE__,##__VA_ARGS__) 
#define    LOG_EROR(...) 			g_pLog->LogEror(__FILE__,__FUNCTION__,__LINE__,##__VA_ARGS__) 
#else
#define    LOG_INFO(args...) 		g_pLog->LogInfo(__FILE__,__func__,__LINE__,##args) 	
#define    LOG_WARN(args...) 		g_pLog->LogWarn(__FILE__,__func__,__LINE__,##args) 
#define    LOG_EROR(args...) 		g_pLog->LogEror(__FILE__,__func__,__LINE__,##args) 
#endif
